...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (isset($_POST['check_in'])) {
            $sql = "INSERT INTO attendance (id, name, date, day_of_week, check_in_time) VALUES (?, ?, ?, ?, ?)
            ...
            if ($check_in_row) {
                ...
                // 0時0分からの経過分数を計算
                $check_in_minutes = ($check_in_timestamp - strtotime($current_date . " 00:00:00")) / 60;
                $check_out_minutes = ($check_out_timestamp - strtotime($current_date . " 00:00:00")) / 60;
